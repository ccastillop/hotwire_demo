...
class AvatarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avatar" do
    assert_difference('Avatar.count') do
      post avatars_url, params: { avatar: { image_url: @avatar.image_url, name: @avatar.name } }
    end
  ...
  test "should update avatar" do
    patch avatar_url(@avatar), params: { avatar: { image_url: @avatar.image_url, name: @avatar.name } }
